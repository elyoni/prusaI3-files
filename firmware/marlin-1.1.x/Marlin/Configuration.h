...
// Mechanical endstop with COM to ground and NC to Signal uses "true" here (most common setup).
...
*/
#define DEFAULT_AXIS_STEPS_PER_UNIT    { 80.5, 80.5, 4180, 609.05 } //{ 80.5, 80.5, 4180, 640 } //{ 80, 80, 400, 96 }
...
/**
   ...
   Override with M201
                                        X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
*/
#define DEFAULT_MAX_ACCELERATION    { 2000, 2000, 100, 10000 }   //  { 2000, 2000, 2000, 1000 } // { 3000, 3000, 100, 10000 }
...
#define DELAY_BEFORE_PROBING 50 //MARK01  // 200(ms) To prevent vibrations from triggering piezo sensors
...
// #define MIN_SOFTWARE_ENDSTOPS // Disable when I added the BLTOUCH
...
#define AUTO_BED_LEVELING_BILINEAR  //MARK01
